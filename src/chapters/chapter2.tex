...
\begin{center}
	...
	\end{tikzpicture}
\end{center}
Note that sometimes when we draw vectors as line segments.
Other times, drawing drawing vectors as line segments can make
it hard to see what's going on, and so it is better to draw
