...
combinations. Certain restrictions have special names, the most useful
...
\begin{definition}[Convex Combination]
	...
	\]
	is a \emph{convex combination} of $\vec v_1,\ldots,\vec v_n$
...
\vec v_n$ would be the convex combination with coefficients $\alpha_i=\frac{1}{n}$). 
