...
\begin{definition}[Parameterization]
	...
	Sometimes we will drop the requirement that a parameterization has to be one-to-one,
...
and time.  Time has a forward and backward, which we equate to
...
$\mathcal S$ is uniquely determined by a direction (forward or backward along $\mathcal S$)
