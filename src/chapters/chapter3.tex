...
\begin{center}
	\begin{tikzpicture}
		...
		\draw[->,myorange,ultra thick] ($({cos(30)}, {sin(30)})$) -- ($({-sin(30)+cos(30)}, {cos(30)+sin(30)})$) node[midway, above right, xshift=0cm] {$\Vel \vec c$};		
		...
		\draw[->,myorange, ultra thick, xshift=.1cm,yshift=-.1cm] (1,1) -- (2,2) node[midway, below right, xshift=0cm] {$\Vel \vec l$};		
...
\begin{center}
	\begin{tikzpicture}
		...
		\draw[->, ultra thick, blue] ($(smallOrigin)+(DA)$) -- ($(smallOrigin)+(DB)$) node[midway, right] {\begin{tabular}{c}big curvature\\= big change\end{tabular}};
...
\begin{example}
	...
	$\vec r(t)$ to $\vec r(t+\Delta t)$.  At position
