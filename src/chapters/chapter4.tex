		...
		\begin{center}
			\begin{tikzpicture}[y=0.80pt, x=0.80pt, yscale=-1.200000, xscale=1.200000, inner sep=0pt, outer sep=0pt]
				\begin{scope}[shift={(.5cm, .5cm)}]
					\node[] (center) at (1.5cm,.2cm) {\footnotesize60$^\circ$};
					\node[] (center) at (1.5cm,.6cm) {\footnotesize65$^\circ$};
					\node[] (center) at (1.7cm,1.1cm) {\footnotesize70$^\circ$};
					\node[] (center) at (2cm,1.7cm) {\footnotesize75$^\circ$};
					\node[] (center) at (3.5cm,4cm) {\footnotesize75$^\circ$};
					\node[] (center) at (5cm,4cm) {\footnotesize80$^\circ$};
					\node[] (center) at (5.6cm,4cm) {\footnotesize85$^\circ$};
					\node[] (center) at (6.2cm,3.7cm) {\footnotesize90$^\circ$};
					\node[] (center) at (6.5cm,6.1cm) {\footnotesize80$^\circ$};
					\node[] (center) at (6.5cm,6.5cm) {\footnotesize85$^\circ$};
					\node[] (center) at (1.8cm,6.1cm) {\footnotesize70$^\circ$};
					\node[] (center) at (1.0cm,5.4cm) {\footnotesize65$^\circ$};
					\node[] (center) at (.3cm,4.6cm) {\footnotesize60$^\circ$};
				\end{scope}
				\begin{scope}[shift={(0,-768.89769)}]
					\path[draw=black,dash pattern=on 19.20pt off 0.80pt,line join=miter,line cap=butt,miter limit=4.00,even odd rule,line width=0.800pt] (40.4939,786.4769).. controls (51.9131,803.9482) and (85.2481,804.9957) .. (100.7078,786.5757);
					\path[draw=black,dash pattern=on 19.20pt off 0.80pt,line join=miter,line cap=butt,miter limit=4.00,even odd rule,line width=0.800pt] (33.4668,786.6746) .. controls (43.8318,812.5257) and (77.5621,839.5231) .. (109.1843,786.5560);
					\path[draw=black,dash pattern=on 19.20pt off 0.80pt,line join=miter,line cap=butt,miter limit=4.00,even odd rule,line width=0.800pt] (28.0647,786.7734) .. controls (51.4299,844.2467) and (90.5185,857.1920) .. (115.8162,786.8327);
					\path[draw=black,dash pattern=on 19.20pt off 0.80pt,line join=miter,line cap=butt,miter limit=4.00,even odd rule,line width=0.800pt] (17.8314,851.3814) .. controls (33.4668,865.3742) and (37.8588,904.1114) .. (39.7912,925.4564) ..
					controls (41.7237,946.8013) and (29.2505,982.3367) .. (17.8314,989.8470);
					\path[draw=black,dash pattern=on 19.20pt off 0.80pt,line join=miter,line cap=butt,miter limit=4.00,even odd rule,line width=0.800pt] (17.7875,1004.0572) .. controls (39.5716,993.8591) and (49.9806,961.1103) ..
					(54.3726,936.2079) .. controls (58.7645,911.3054) and (40.4500,844.0886) .. (17.6996,840.6101);
					\path[draw=black,dash pattern=on 19.20pt off 0.80pt,line join=miter,line cap=butt,miter limit=4.00,even odd rule,line width=0.800pt] (17.8753,831.4002) .. controls (26.3079,837.7246) and (46.2913,849.7213) .. (55.0753,869.2479) .. controls (63.8592,888.7746) and (87.4002,975.3403) .. (78.4405,992.7325) ..
					controls (69.4809,1010.1247) and (26.7471,1018.0895) .. (17.9631,1019.1172);
					\path[draw=black,dash pattern=on 19.20pt off 0.80pt,line join=miter,line cap=butt,miter limit=4.00,even odd rule,line width=0.800pt] (265.7580,899.3681) -- (241.9974,899.3681) -- (241.9974,934.5477) -- (265.3627,934.5477);
					\path[draw=black,dash pattern=on 19.20pt off 0.80pt,line join=miter,line cap=butt,miter limit=4.00,even odd rule,line width=0.800pt] (265.6701,883.9523) .. controls (248.6293,884.0314) and (231.8080,892.8065) .. (225.6593,902.6093) .. controls (219.5105,912.4122) and (221.2673,936.6822) .. (224.4295,942.9276) .. controls (227.5918,949.1730) and (260.1802,954.7266) .. (265.9776,955.0428);
					\path[draw=black,dash pattern=on 19.20pt off 0.80pt,line join=miter,line cap=butt,miter limit=4.00,even odd rule,line width=0.800pt] (265.5823,867.9831) .. controls (247.6631,870.3547) and (217.0510,880.2367) .. (208.9698,897.7870) .. controls (200.8886,915.3373) and (211.6050,945.7736) .. (213.5375,956.5251) .. controls (215.4699,967.2767) and (255.7004,975.5775) .. (265.8897,974.9451);
					\path[draw=black,dash pattern=on 19.20pt off 0.80pt,line join=miter,line cap=butt,miter limit=4.00,even odd rule,line width=0.800pt] (265.8897,842.7644) .. controls (220.5646,838.4954) and (159.9555,819.4430) .. (127.1035,837.8630) .. controls (94.2516,856.2829) and (74.0486,855.2552) .. (84.2379,880.7110) .. controls (94.4273,906.1668) and (110.0627,983.4830) .. (102.6842,1001.7448) .. controls (95.3057,1020.0066) and (94.6030,1027.4378) .. (85.9947,1034.4738);
					\path[draw=black,dash pattern=on 19.20pt off 0.80pt,line join=miter,line cap=butt,miter limit=4.00,even odd rule,line width=0.800pt] (265.9336,988.9181) .. controls (235.7169,986.3883) and (200.1859,978.1863) .. (179.8071,957.6319) .. controls (159.4284,937.0775) and (138.1713,932.9666) .. (128.6846,942.9276) .. controls (119.1980,952.8886) and (122.1845,1002.5354) .. (117.0899,1012.8126) .. controls (111.9952,1023.0898) and (106.5491,1034.5528) .. (106.5491,1034.5528);
					\path[draw=black,dash pattern=on 19.20pt off 0.80pt,line join=miter,line cap=butt,miter limit=4.00,even odd rule,line width=0.800pt] (265.7140,1009.5713) .. controls (238.8352,1007.5949) and (212.8348,1008.8994) .. (203.6116,1034.6517);
					\path[draw=black,dash pattern=on 19.20pt off 0.80pt,line join=miter,line cap=butt,miter limit=4.00,even odd rule,line width=0.800pt] (266.0654,1023.6432) -- (225.3079,1023.6432) -- (225.3079,1034.3947);
					\path[draw=black,line join=round,miter limit=4.00,line width=0.800pt,rounded corners=0.0000cm] (17.7165,786.6142) rectangle (265.7480,1034.6457);
					\path[draw=black,line join=miter,line cap=butt,even odd rule,line width=0.800pt] (17.7165,822.0473) -- (17.7165,822.0473) -- (17.7165,822.0473) -- (17.7165,822.0473) -- (17.7165,822.0473) -- (17.7165,822.0473) -- (22.1505,822.0473);
					\path[draw=black,line join=miter,line cap=butt,even odd rule,line width=0.800pt] (17.9218,857.4804) -- (17.9218,857.4804) -- (17.9218,857.4804) -- (17.9218,857.4804) -- (17.9218,857.4804) -- (17.9218,857.4804) -- (22.3558,857.4804);
					\path[draw=black,line join=miter,line cap=butt,even odd rule,line width=0.800pt] (17.3594,892.8375) -- (17.3594,892.8375) -- (17.3594,892.8375) -- (17.3594,892.8375) -- (17.3594,892.8375) -- (17.3594,892.8375) -- (21.7934,892.8375);
					\path[draw=black,line join=miter,line cap=butt,even odd rule,line width=0.800pt] (17.7165,928.3465) -- (17.7165,928.3465) -- (17.7165,928.3465) -- (17.7165,928.3465) -- (17.7165,928.3465) -- (17.7165,928.3465) -- (22.1505,928.3465);
					\path[draw=black,line join=miter,line cap=butt,even odd rule,line width=0.800pt] (17.7165,963.7796) -- (17.7165,963.7796) -- (17.7165,963.7796) -- (17.7165,963.7796) -- (17.7165,963.7796) -- (17.7165,963.7796) -- (22.1505,963.7796);
					\path[draw=black,line join=miter,line cap=butt,even odd rule,line width=0.800pt] (17.7165,999.2127) -- (17.7165,999.2127) -- (17.7165,999.2127) -- (17.7165,999.2127) -- (17.7165,999.2127) -- (17.7165,999.2127) -- (22.1505,999.2127);
					\path[draw=black,line join=miter,line cap=butt,even odd rule,line width=0.800pt] (53.2200,786.5438) -- (53.2200,786.5438) -- (53.2200,786.5438) -- (53.2200,786.5438) -- (53.2200,786.5438) -- (53.2200,786.5438) -- (53.2200,790.9778);
					\path[draw=black,line join=miter,line cap=butt,even odd rule,line width=0.800pt] (88.6531,786.5438) -- (88.6531,786.5438) -- (88.6531,786.5438) -- (88.6531,786.5438) -- (88.6531,786.5438) -- (88.6531,786.5438) -- (88.6531,790.9778);
					\path[draw=black,line join=miter,line cap=butt,even odd rule,line width=0.800pt] (124.0862,786.5438) -- (124.0862,786.5438) -- (124.0862,786.5438) -- (124.0862,786.5438) -- (124.0862,786.5438) -- (124.0862,786.5438) -- (124.0862,790.9778);
					\path[draw=black,line join=miter,line cap=butt,even odd rule,line width=0.800pt] (159.5192,786.5438) -- (159.5192,786.5438) -- (159.5192,786.5438) -- (159.5192,786.5438) -- (159.5192,786.5438) -- (159.5192,786.5438) -- (159.5192,790.9778);
					\path[draw=black,line join=miter,line cap=butt,even odd rule,line width=0.800pt] (194.9523,786.5438) -- (194.9523,786.5438) -- (194.9523,786.5438) -- (194.9523,786.5438) -- (194.9523,786.5438) -- (194.9523,786.5438) -- (194.9523,790.9778);
					\path[draw=black,line join=miter,line cap=butt,even odd rule,line width=0.800pt] (230.3854,786.6701) -- (230.3854,786.6701) -- (230.3854,786.6701) -- (230.3854,786.6701) -- (230.3854,786.6701) -- (230.3854,786.6701) -- (230.3854,791.1041);
				\end{scope}
			\end{tikzpicture}
		\end{center}
		\vspace{-.5cm}
	...
	\begin{center}
		\begin{tikzpicture}[y=0.80pt, x=0.80pt, yscale=-1.200000, xscale=1.200000, inner sep=0pt, outer sep=0pt]
			\begin{scope}[shift={(.5cm, .5cm)}]
				...
				\node[] (center) at (1.0cm,5.4cm) {\footnotesize65$^\circ$};
				\node[] (center) at (.3cm,4.6cm) {\footnotesize60$^\circ$};
				\fill (0cm,4.3cm) circle [radius=2pt] node[left, xshift=-3pt] {$P$};
				\fill (6cm,1.8cm) circle [radius=2pt] node[right, xshift=3pt] {$Q$};
				\draw[->, very thick, red] (0cm,4.3cm) to (6cm, 1.8cm);
			\end{scope}
			\begin{scope}[shift={(0,-768.89769)}]
				\path[draw=black,dash pattern=on 19.20pt off 0.80pt,line join=miter,line cap=butt,miter limit=4.00,even odd rule,line width=0.800pt] (40.4939,786.4769).. controls (51.9131,803.9482) and (85.2481,804.9957) .. (100.7078,786.5757);
				\path[draw=black,dash pattern=on 19.20pt off 0.80pt,line join=miter,line cap=butt,miter limit=4.00,even odd rule,line width=0.800pt] (33.4668,786.6746) .. controls (43.8318,812.5257) and (77.5621,839.5231) .. (109.1843,786.5560);
...
\begin{restatable*}[Directional Derivative]{definition}{DefDirectionalDerivative}
...
\begin{example}
	...
	\begin{tikzpicture}
	    \begin{axis}[grid=major,view={20}{20},z buffer=sort,
		    ...
		    \addplot3[surf, point meta min=-1,
...
\begin{center}
	\begin{tikzpicture}[scale=.7]
		...
		\draw (plot1.south) node[below] {Hyperboloid of one sheet};	
...
a limit as $\alpha\to 0$ gives us an instantaneous rate of change---one worth naming.
...
\emph{partial derivative}\index{partial derivative}.
...
\begin{center}
	\begin{tikzpicture}
		...
		\addplot3[domain=-1:5, samples y=1, mypink, thick] ({x},{0},{0});
		\addplot3[domain=-3:3, samples y=1, mygreen, thick] ({0},{x},{0});

        \addplot3[surf, domain=-1:5, y domain=-3:3, shader=interp, opacity=1] {-(x-2)^2-y^2+20};

		\addplot3[domain=-1:5, samples y=1, mypink, thick] ({x},{0},{-(x-2)^2-0^2+20}) node[midway, above right] {$\vec p\circ \vec r_y$};
		\addplot3[domain=-3:3, samples y=1, mygreen, thick] ({0},{x},{-(0-2)^2-x^2+20}) node[at start, right, mygreen!80!black] {$\vec p\circ \vec r_x$};

		\draw[fill] (0,0,16) circle (1.5pt) node (A) {} node[right] {$\vec a$};
		...
		\addplot3[domain=-1:5, samples y=1, mypink, thick] ({x},{0},{-(x-2)^2-0^2+20}) node[midway, above right] {$\vec p\circ \vec r_y$};
		\addplot3[domain=-3:3, samples y=1, mygreen, thick] ({0},{x},{-(0-2)^2-x^2+20}) node[near start, above, mygreen!50!white] {$\vec p\circ \vec r_x$};

		\draw[fill] (0,0,16) circle (1.5pt) node (A) {} node[right] {$\vec a$};

	    \end{axis}
		\draw (plot1.north) node[above] {Top view};
		\draw (plot0.north) node[above] {Perspective view};

	  \end{tikzpicture}
\end{center}

Further, $\vec p\circ \vec r_x(0)=(a_x,a_y,f(a_x,a_y))=\vec a$.  Thus, if we want a tangent
vector to $\mathcal S$ at $\vec a$, all we need to do is compute $(\vec p\circ \vec r_x)'(0)$.
...
xticklabels={,,}, yticklabels={,,}, zticklabels={,,},
		...
		\draw[fill] (0,0,16) circle (1.5pt) node (A) {};

		\draw[->,thick] (0,0,16) -- (0,-2,16) node[at end,right]{$(\vec p\circ \vec r_x)'(0)$};
		\draw[->,thick, black] (0,0,16) -- (2,0,24)  node[midway, left,yshift=.2cm]{$(\vec p\circ \vec r_y)'(0)$};
	    \end{axis}
	  \end{tikzpicture}
\end{center}
...
have just as easily used the parameterization $\vec p\circ \vec r_y$ where $\vec r_y(t)=(a_x,a_y+t)$.
Or, we could have parameterized paths
that weren't parallel to either the $x$ or $y$ axes.  For instance
$\vec p\circ \vec r_{d}$ where $\vec r_{d}(t) = (a_x+td_x, a_y+td_y)$
for non-zero constants $d_x,d_y$.  The derivative of any such parameterization will
give us tangent vectors to $\mathcal S$.
...
surface, 
$\mathcal P$ will be a plane. In this case we call $\mathcal P$ the 
\emph{tangent plane}\index{tangent plane}
to $\mathcal S$ at $\vec a$.  (Recall that if $\mathcal P$ is a plane,
...
are called \emph{affine functions}\index{affine function} and 
show up in the context of \emph{linear approximations}\index{linear approximations}\footnote{
...
The above formula can be used to compute the directional derivative of $f$ in an arbitrary direction!  
There's more:
\[
...
comes up often and is called the \emph{gradient}\index{gradient}.
...
Recall from single variable calculus: if $f:\R\to\R$ is a differentiable function,
...
\begin{center}
	\begin{tikzpicture}
		...
		\addplot[mypink,thick,smooth] (x,{(x+2)^2/4-3});
		\addplot[myorange, thick] (x,{27*x/20-849/400});

		\coordinate (A) at (3,3);
		\coordinate (B) at (3,2);
		\coordinate (C) at (7/10,-471/400);
		\coordinate (D) at (3,-2);

		\end{axis}	

		\draw (A) node[left,xshift=-.1cm] {$y=f(x)$};
		\draw (B) node[xshift=.1cm,right] {First-order approximation};
		\draw (D) node[right] {Point of tangency} edge[bend right, ->] ([xshift=.1cm]C) node {};
		%\path[thick] (7.5,3.5) node[above] {Corresponding curves} edge[bend left, ->] node[] {} (B) edge[bend right, ->] (A);
...
\addplot3 [blue, domain=-1:5, y domain=-3:3, quiver={u={-2*x+4}, v={-2*y}, scale arrows=0.14, every arrow/.append style={-stealth}}, samples=10] (x,y,0) node[above] (A) {};
	    ...
	    \end{axis}
\draw (plot0.south) node[below right] {$\nabla f$};
	  \end{tikzpicture}
\end{center}
...
\addplot3 [blue, domain=-1:5, y domain=-3:3, quiver={u={-2*x+4}, v={-2*y}, scale arrows=0.14, every arrow/.append style={-stealth}}, samples=10] (x,y,0) node[above] (A) {};
		...
		\draw[thick, mypink] (2,0,0) ellipse[x radius=sqrt(#1), y radius=sqrt(#1)];
		}
...
When dealing with functions coming from the real world,
...
\begin{example}
	...
	\begin{tikzpicture}
	    ...
	    \begin{axis}[grid=major,view={0}{90},zmin=0,
...
%xticklabels={,,}, yticklabels={,,}, zticklabels={,,},
        ...
        \addplot3[surf, domain=-2:3, shader=interp, opacity=1,samples=60,
			point meta max=20] {(x^2+2*y^2)};
		\end{scope}

	    \end{axis}
\draw (plot0.north) node[above] {$f(x,y)=x^2+2y^2$};
	  \end{tikzpicture}
	\end{center}
\end{example}
...
%xticklabels={,,}, yticklabels={,,}, zticklabels={,,},
		...
		\begin{scope}[opacity=1]
        \addplot3[surf, domain=-2:2, shader=interp, opacity=1,samples=80] {(x^2-y^2)/(x^2+y^2)};
		\end{scope}

	    \end{axis}
\draw (plot0.north) node[above] {$f(x,y)=\frac{x^2-y^2}{x^2+y^2}$};
	  \end{tikzpicture}
	\end{center}
\end{example}
...
\begin{center}
	\begin{tikzpicture}	   
	 \begin{axis}[grid=major,view={-50}{25},
		    colormap/copper,
			name=plot0
		    ]


        \addplot3[surf, domain=-2:2, shader=interp, opacity=1] {4-x^2-y^2};



		\draw[fill] (0,0,4) circle (1.5pt) node[right] (A) {Global maximum};
...
\begin{center}
	\begin{tikzpicture}	   
	 \begin{axis}[grid=major,view={-50}{25},zmin=-4,
		    colormap/copper,
%xticklabels={,,}, yticklabels={,,}, zticklabels={,,},
			name=plot0
		    ]

		\addplot3[domain=-2:2, samples y=1, mypink, thick, densely dashed] ({0},{x},{-4});

        \addplot3[surf, domain=-2:2, shader=interp, opacity=1, samples=20] {4-x^2-y^2};


		\addplot3[domain=-2:2, samples y=1, mypink, thick] ({0},{x},{4-x^2}) node[near start, right, mypink, xshift=.1cm] {};
	    \end{axis}
		...
		\addplot[domain=-4:4, samples=20, samples y=1, smooth,thick, mypink] (x, 4-x^2);
		\draw (1.7,2) node (A){};

		\end{axis}	

		\draw (A) node[right] {$z=f\circ \vec p(t)$};
	  \end{tikzpicture}
\end{center}
...
\begin{center}
	\begin{tikzpicture}	   
		...
		\addplot[domain=-4:4, samples=20, samples y=1, smooth,thick, mypink] (x, x^3/5);
		\draw (0,0) node (A){};
		\draw (-2,2) node (B) {};
		...
		\draw (B) node[left] {Stationary point} edge[bend left, ->] (A);
	  \end{tikzpicture}
\end{center}
...
\begin{example}
	...
	\begin{center}
		...
		\begin{tikzpicture}
		 ...
		 \begin{axis}[grid=major,view={60}{25},xmin=-2,xmax=2,ymin=-2,ymax=2,
			    colormap/viridis,  %ytick=\empty,xtick=\empty,
	%xticklabels={,,}, yticklabels={,,}, zticklabels={,,},
				name=plot0
			    ]
	...
	%xticklabels={,,}, yticklabels={,,}, zticklabels={,,},
		...
		%\addplot3[surf, domain=-2:2, shader=interp, opacity=1, samples=20] {(x-2)^2+(y-3)^2};


	\addplot3 [myorange, domain=-2:2,  quiver={u={-x}, v={-y}, scale arrows=0.24, every arrow/.append style={-stealth}}, samples=10] (x,y,0) node[above] (A) {};		
			...
			\draw (plot2.north) node[above, yshift=.2cm] {$\nabla f $};
			\draw (plot0.north) node[above, yshift=.2cm] {$z= f(x,y) $};
		  \end{tikzpicture}
	\end{center}
...
\addplot3[surf, domain=-2:2, shader=interp, opacity=1, samples=20] {4-x^2+y^3};
...
xshift=.5cm,
		...
		\addplot3 [myorange, domain=-2:2,  quiver={u={-2*x}, v={3*abs(y)}, scale arrows=0.1, every arrow/.append style={-stealth}}, samples=10] (x,y,0) node[above] (A) {};
...
passing through $\vec a$.  Then, $\ell$ has a parameterization $\vec p(t)=\vec a+t\vec u$.
...
\definecolorseries{test}{rgb}{grad}[rgb]{0,0,1}{0,1,0}
\resetcolorseries[360]{test}

	\begin{tikzpicture}


	 \begin{axis}[grid=major,view={80}{25},zmin=-4,
		    colormap/copper,
%xticklabels={,,}, yticklabels={,,}, zticklabels={,,},
			name=plot0
		    ]
	...
	\addplot3[domain=-180:179, samples y=1, mypink, thick, smooth, densely dashed] ({cos(x)},{sin(x)},{-4}) node[near start, right, mypink, xshift=.1cm] {};

        \addplot3[surf, domain=-2:2, shader=interp, opacity=1, samples=20] {(x-2)^2+(y-3)^2};


		\addplot3[domain=0:360, samples y=1, mypink, thick, smooth] ({cos(x)},{sin(x)},{(cos(x)-2)^2+(sin(x)-3)^2});

		\pgfplotsinvokeforeach {0,15,...,350} {
			\draw[fill={test!![#1]}, draw=none] ({cos(#1)}, {sin(#1)}, {(cos(#1)-2)^2+(sin(#1)-3)^2}) circle (1.5pt);
		}

		\draw (-.56, -.84 , 21.211) node (M1) {};
	    \end{axis}
		...
		\addplot[domain=0:{2*pi}, samples=20, samples y=1, smooth,thick, mypink] (x, {-6*sin(deg(x))-4*cos(deg(x))+14});
		\draw (4.124, 21.211) node (M2) {};
		\pgfplotsinvokeforeach {0,15,...,350} {

			\draw[fill={test!![#1]}, draw=none] (#1/360*2*pi, {-6*sin(#1)-4*cos(#1)+14}) circle (1.5pt);
		}
		\draw (1.8,20) node (A){};
		\end{axis}	

		\draw (A) node[] {$z=f\circ \vec p(t)$};

		\draw (plot0.north) node[above] {Corresponding extrema} edge[bend right, ->] (M1) edge[bend left, ->] (M2);
	  \end{tikzpicture}
	\end{center}
...
\begin{center}
	\begin{tikzpicture}
	 ...
	 \begin{axis}[grid=major,view={80}{25},zmin=0,
		    colormap/viridis,
xticklabels={,,}, yticklabels={,,}, zticklabels={,,},
			name=plot0
		    ]
	...
	\addplot3[domain=-180:179, samples y=1, mypink, thick, smooth, densely dashed] ({cos(x)},{sin(x)},{0}) node[near start, right, mypink, xshift=.1cm] {};
	 ...
	 \begin{axis}[grid=major,view={80}{25},zmin=0,xmin=-2,xmax=2,ymin=-2,ymax=2,zmax=45,
xshift=.5cm,
		    colormap/copper,
%enlargelimits=.05,
xticklabels={,,}, yticklabels={,,}, zticklabels={,,},
	...
	\addplot3[domain=-180:179, samples y=1, mypink, thick, smooth, densely dashed] ({cos(x)},{sin(x)},{0}) node[near start, right, mypink, xshift=.1cm] {};
		...
		\draw ({cos(deg(4.12))}, {sin(deg(4.12))}, {(cos(deg(4.12))-2)^2+(sin(deg(4.12))-3)^2}) node (A) {}; % circle (1.5pt);
		\draw ({cos(deg(4.2+pi))}, {sin(deg(4.2+pi))}, {(cos(deg(4.2+pi))-2)^2+(sin(deg(4.2+pi))-3)^2}) node (B) {}; % circle (1.5pt);

		\pgfplotsinvokeforeach {0, 30, ..., 350} {
			%\draw[->] ({cos(#1)}, {sin(#1)}, {(cos(#1)-2)^2+(sin(#1)-3)^2}) --  ({cos(#1) + sin(#1)}, {sin(#1)-cos(#1)}, {(cos(#1)-2)^2+(sin(#1)-3)^2 - (-2*(cos(#1)-2)*sin(#1)+3*(sin(#1)-3)*cos(#1))});
			\draw[myorange,->] ({cos(#1)}, {sin(#1)}, {0}) --  ({cos(#1) + sin(#1)}, {sin(#1)-cos(#1)}, {0});
		}
		\draw (-.56, -.84 , 21.211) node (M1) {};
		...
		\draw (plot2.north) node[above] {$\nabla f(\vec r(t))\cdot \vec T_{\vec r(t)}=0$} edge[bend right, ->] (A) edge[bend left, ->] (B);
	  \end{tikzpicture}
\end{center}
...
\begin{center}
	...
	\begin{tikzpicture}
	 ...
	 \begin{axis}[grid=major,view={80}{25},zmin=0,xmin=-2,xmax=2,ymin=-2,ymax=2,
		    colormap/viridis,
xticklabels={,,}, yticklabels={,,}, zticklabels={,,},
			name=plot0
		    ]
...
\addplot3 [myorange, domain=-2:2,  quiver={u={-1*sign(y)*sqrt(abs(y))}, v={sign(x)*sqrt(abs(x))}, scale arrows=0.24, every arrow/.append style={-stealth}}, samples=10] (x,y,0) node[above] (A) {};
		...
		\foreach \h in {2.9, 4.9, ..., 40} {
			\pgfmathsetmacro\start{270 - acos(1/sqrt(\h)) - 1}
		\addplot3[domain=\start:270, samples y=1, white, thin, smooth, samples=150, restrict y to domain=-2:2, restrict x to domain=-2:2] ({(sqrt(\h)*cos(x)+2)},{(sqrt(\h)*sin(x)+3)},{\h});
	}
	 ...
	 \begin{axis}[grid=major,view={90}{90},zmin=0,xmin=-2,xmax=2,ymin=-2,ymax=2,zmax=45,
xshift=.5cm,
		    colormap/viridis,
%enlargelimits=.05,
xticklabels={,,}, yticklabels={,,}, zticklabels={,,},
		...
		\foreach \h in {2.9, 4.9, ..., 40} {
			\pgfmathsetmacro\start{270 - acos(1/sqrt(\h))}
		\addplot3[domain=\start:270, samples y=1, white, thin, smooth] ({(sqrt(\h)*cos(x)+2)},{(sqrt(\h)*sin(x)+3)},{\h});
	}
...
\addplot3 [myorange, domain=-2:2,  quiver={u={-1*sign(y)*sqrt(abs(y))}, v={sign(x)*sqrt(abs(x))}, scale arrows=0.24, every arrow/.append style={-stealth}}, samples=10] (x,y,0) node[above] (A) {};		
		...
		\draw (plot2.north) node[above, yshift=.2cm] {$\nabla f(\vec a)\cdot \vec T(\vec a)=0$} edge[bend right, ->,black,thick] (A) edge[bend left, ->,thick] (B);
	  \end{tikzpicture}
\end{center}
...
\begin{center}
	...
	\begin{tikzpicture}
	 ...
	 \begin{axis}[grid=major,view={90}{90},zmin=0,xmin=-2,xmax=2,ymin=-2,ymax=2,
		    colormap/viridis,ytick=\empty,xtick=\empty,
%xticklabels={,,}, yticklabels={,,}, zticklabels={,,},
			name=plot0
		    ]
		...
		\foreach \h in {2.9, 4.9, ..., 40} {
		\pgfmathsetmacro\start{270 - acos(1/sqrt(\h))-1 - mod(\h,4)*5}
		\addplot3[domain=\start:270, samples y=1, myorange, thin, smooth] ({(sqrt(\h)*cos(x)+2)},{(sqrt(\h)*sin(x)+3)},{\h});
\addplot3[domain=\start:270, samples=15, samples y=1, myorange, thin, smooth,quiver={u={2*x-4}, v={2*y-6}, scale arrows=0.025, every arrow/.append style={-stealth}}] ({(sqrt(\h)*cos(x)+2)},{(sqrt(\h)*sin(x)+3)},{\h});
	}
...
%\addplot3 [myorange, domain=-2:2,  quiver={u={-1*sign(y)*sqrt(abs(y))}, v={sign(x)*sqrt(abs(x))}, scale arrows=0.24, every arrow/.append style={-stealth}}, samples=10] (x,y,0) node[above] (A) {};		
		...
		\addplot3[domain=0:360, samples y=1, mypink, thick, smooth] ({cos(x)},{sin(x)},{(cos(x)-2)^2+(sin(x)-3)^2});
		\addplot3[domain=0:360, samples y=1, mypink,quiver={u={-y}, v={x}, scale arrows=0.5, every arrow/.append style={-stealth}}] ({cos(x)},{sin(x)},{(cos(x)-2)^2+(sin(x)-3)^2});

	    \end{axis}


		\draw (plot0.north) node[above, yshift=.2cm] {{\color{myorange}$\nabla f$} orthogonal to {\color{mypink}$\vec T$}} edge[bend right, ->,black] (A) edge[bend left, ->] (B);
...
%\addplot3 [myorange, domain=-2:2,  quiver={u={-1*sign(y)*sqrt(abs(y))}, v={sign(x)*sqrt(abs(x))}, scale arrows=0.24, every arrow/.append style={-stealth}}, samples=10] (x,y,0) node[above] (A) {};		
		...
		\addplot3[domain=0:360, samples y=1, mypink, thick, smooth] ({cos(x)},{sin(x)},{(cos(x)-2)^2+(sin(x)-3)^2});
		\addplot3[domain=0:360, samples y=1, mypink,quiver={u={x}, v={y}, scale arrows=0.25, every arrow/.append style={-stealth}}] ({cos(x)},{sin(x)},{(cos(x)-2)^2+(sin(x)-3)^2});

	    \end{axis}


		\draw (plot2.north) node[above, yshift=.2cm] {{\color{myorange}$\nabla f$} parallel to {\color{mypink}$\nabla g$}} edge[bend right, ->,black] (A) edge[bend left, ->] (B);
	  \end{tikzpicture}
\end{center}
